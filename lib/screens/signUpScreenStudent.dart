...
class signUpScreenStudent extends StatefulWidget {
  ...
  @override
  State<signUpScreenStudent> createState() => _signUpScreenStudentState();
}
class SkillSet {
  final int id;
  final String name;
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(width: 220,child: Text('Which type of teaching are you prefer?',style: TextStyle(fontSize: 16,fontFamily: 'regular',color: Color(0xFF6a6a6a)),maxLines: 2)),
                              )
