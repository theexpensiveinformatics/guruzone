...
class _signUpScreenMentorState extends State<signUpScreenMentor> {
  ...
  final _langitems = _languages
      .map((languages) =>
          MultiSelectItem<languageSet>(languages, languages.name))
      .toList();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'GuruZone',
                    style: TextStyle(
                        fontFamily: 'bold', fontSize: 25, color: darkText),
                  ),
                  Text(
                    'Let\'s ready to serve knowledge!',
                    style: TextStyle(
                        fontFamily: 'regular', fontSize: 16, color: darkText),
                  ),
                  SizedBox(
                    height: 20,
                  ),
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                    width: 220,
                                    child: Text(
                                        'Which type of service can you provide?',
                                        style: TextStyle(
                                            fontSize: 16,
                                            fontFamily: 'regular',
                            ...
                            children: [
                                ...
                                child: Container(
                                  ...
                                  decoration:
                                      teachingType == 'Partially Personalized'
                                          ...
                                          : choiceDisable,
                                  alignment: Alignment.center,
                                  child: Text('Partially Personalized',
                                      style: TextStyle(
                                          color: teachingType ==
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  width: double.infinity,
                                  height: 50,
                                  decoration: teachingType == 'Both'
                                      ? choiceEnable
                                      : choiceDisable,
                                  alignment: Alignment.center,
                                  child: Text('Both',
                                      style: TextStyle(
                                          color: teachingType == 'Both'
                                              ? Colors.white
                                              : Color(0xff6a6a6a),
                                          fontFamily: 'regular')),
                                ),
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: MultiSelectDialogField(
                                    buttonIcon: Icon(Icons.arrow_circle_down,
                                        color: darkText),
                                    title: Text('Skills',
                                        style: TextStyle(
                                            fontSize: 16,
                                    ...
                                    itemsTextStyle: TextStyle(
                                        fontFamily: 'regular', color: darkText),
                                    searchTextStyle:
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child:
                          Text('Already have an account ?', style: blueRegular),
                    ),
                  ),
                    ...
                    onTap: () async {
                      ...
                      if (name.isNotEmpty) {
                        ...
                        final response = await http.post(
                          Uri.parse(
                              'https://vadodara-hackthon-4-0.vercel.app/api/v1/auth/register'),
