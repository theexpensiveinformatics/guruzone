...
class chatReplyContainer extends StatelessWidget {
  final Widget child;
      ...
      child: Container(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color: blue,
              borderRadius: BorderRadius.only(topRight: Radius.circular(borderRadius),topLeft: Radius.circular(borderRadius),bottomLeft: Radius.circular(borderRadius)),
              boxShadow: [
              BoxShadow(
